...
! function(a, b) {
    ...
    e.defaults = {
        ...
        toggleDefaultBehavior: function(a, b, c) {
            ...
            }), "none" == b.userSelect && (a.onselectstart = !c && function() {
                return !1
            }), "none" == b.userDrag && (a.ondragstart = !c && function() {
                return !1
            }))
        }
        ...
        dispose: function() {
            var a, b;
            for (this.options.stop_browser_behavior && e.utils.toggleDefaultBehavior(this.element, this.options.stop_browser_behavior, !0), a = -1; b = this.eventHandlers[++a];) this.element.removeEventListener(b.gesture, b.handler, !1);
    ...
    e.event = {
        ...
        updatePointer: function(a, b) {
            return a == e.EVENT_END ? delete this.pointers[b.pointerId] : (b.identifier = b.pointerId, this.pointers[b.pointerId] = b), Object.keys(this.pointers).length
        },
        ...
        extendEventData: function(a) {
            ...
            var d, f, g = a.timeStamp - b.timeStamp,
        ...
        handler: function(a, b) {
            if (e.detection.current.name != this.name && this.triggered) return b.trigger(this.name + "end", a), void(this.triggered = !1);
            if (!(b.options.drag_max_touches > 0 && a.touches.length > b.options.drag_max_touches)) switch (a.eventType) {
                case e.EVENT_START:
                    this.triggered = !1;
                    break;
                case e.EVENT_MOVE:
                    if (a.distance < b.options.drag_min_distance && e.detection.current.name != this.name) return;
        ...
        handler: function(a, b) {
            return b.options.prevent_mouseevents && a.pointerType == e.POINTER_MOUSE ? void a.stopDetect() : (b.options.prevent_default && a.preventDefault(), void(a.eventType == e.EVENT_START && b.trigger(this.name, a)))
        }
            ...
            if (!(a.touches.length < 2)) {
                if (b.options.transform_always_block && a.preventDefault(), b.options.transform_within_instance)
                    for (var c = -1; a.touches[++c];)
                        if (!e.utils.hasParent(a.touches[c].target, b.element)) return;
                switch (a.eventType) {
                    case e.EVENT_START:
                        this.triggered = !1;
                        break;
                    case e.EVENT_MOVE:
                        ...
                        if (d < b.options.transform_min_scale && f < b.options.transform_min_rotation) return;
